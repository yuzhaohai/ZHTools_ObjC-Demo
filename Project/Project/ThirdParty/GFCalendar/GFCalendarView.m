...
//        self.layer.borderColor = [UIColor zh_colorWithHexString:kColor_F5F5F5].CGColor;
...
//            [button setImage:[UIImage imageNamed:@"WhiteArrow_left"] forState:UIControlStateNormal];
//            button.frame = CGRectMake(0, 0, width / 2.0 - 84, calendarHeaderHeight);
...
//            UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
//            button.backgroundColor = [UIColor clearColor];
//            [button setImage:[UIImage imageNamed:@"WhiteArrow_right"] forState:UIControlStateNormal];
//            button.frame = CGRectMake(width / 2.0 + 84, 0, width / 2.0 - 84, calendarHeaderHeight);
...
- (void)tappedButton:(UIButton *)button {
    if (button.tag == 0) {
        ...
        [_calendarScrollView refreshToPreviousMonth];
        
    } else {
        
        [_calendarScrollView refreshToNextMonth];
...
- (UIButton *)setupCalendarHeaderButtonWithFrame:(CGRect)frame {
    ...
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    button.frame = frame;
    button.backgroundColor = [UIColor zh_colorWithHexString:kColor_Main];
...
- (UIView *)setupWeekHeadViewWithFrame:(CGRect)frame {
    ...
    view.backgroundColor = [UIColor zh_colorWithHexString:kColor_F5F5F5];
    ...
    for (int i = 0; i < 7; ++i) {
        ...
        label.textColor = [UIColor zh_colorWithHexString:kColor_333333];
    ...
    separatorLine.backgroundColor = [UIColor zh_colorWithHexString:kColor_F5F5F5];
...
- (void)setSelectedDate:(NSDate *)selectedDate {
    ...
    self.calendarScrollView.selectedDate = selectedDate;
}
