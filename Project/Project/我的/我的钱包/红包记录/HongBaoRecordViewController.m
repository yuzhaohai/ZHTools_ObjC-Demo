...
#import "HongBaoRecordViewController.h"

@interface HongBaoRecordViewController ()
...
@implementation HongBaoRecordViewController
...
- (void)fetchRequestWithPage:(NSInteger)page {
    [Util POST:@"/api/User/user_redmoney_list" showHUD:NO showResultAlert:YES parameters:@{
        @"limit": @(self.pageSize),
        @"page": @(page),
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BOOL flag = [@"income" isEqualToString:info[@"type"]];
    
    [cell.aLabel setPropertyWithDictionary:@{
        zh_frame: NSStringFromCGRect(CGRectMake(0, 0, zh_ScreenWidth, 55)),
        zh_textColor: (flag ? kColor_333333 : kColor_Red),
        zh_text: [NSString stringWithFormat:@"%@%@", (flag ? @"+" : @"-"), info[@"money"]],
    }];
    [cell.aLabel sizeToFit];
    cell.aLabel.frame = CGRectMake(zh_ScreenWidth - 15 - cell.aLabel.width, 0, cell.aLabel.width, 55);
        
    NSMutableAttributedString *aString = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@\n", info[@"title"]] attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:16], NSForegroundColorAttributeName: [UIColor blackColor]}];
    [aString appendAttributedString:[[NSAttributedString alloc] initWithString:info[@"create_time"] attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:12], NSForegroundColorAttributeName: [UIColor zh_colorWithHexString:kColor_808080]}]];
